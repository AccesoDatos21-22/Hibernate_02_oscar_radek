...
public class SeguroTest {
    ...
    public void introducirSeguro() {
        ...
        Seguro seguroExistente = new Seguro(888, "test01", "oscar", "gonzalez", "Strozzi",
                20, Seguro.Sexos.HOMBRE, "N", 0, Timestamp.valueOf("2021-05-02 04:04:05"), Seguro.Seguros.COCHE,  Date.valueOf("2001-12-03"), Time.valueOf("10:06:13"));
    ...
    public void buscarSeguro() {
        Seguro seguro = new Seguro(339, "test02", "Juan", "Pepe", "Aler",
                19, Seguro.Sexos.HOMBRE, "S", 2, Timestamp.valueOf("2021-07-02 04:04:05"), Seguro.Seguros.COCHE,  Date.valueOf("2001-12-03"), Time.valueOf("10:06:13"));
//        seguroPersistent.insertarSeguro(seguro);
    ...
    public void testMayorEdad() {
        Seguro mayor1 = new Seguro(777, "mayorSI", "oscar", "gonzalez", "Strozzi",
                20, Seguro.Sexos.HOMBRE, "N", 0, Timestamp.valueOf("2021-05-02 04:04:05"), Seguro.Seguros.COCHE,  Date.valueOf("2012-12-03"), Time.valueOf("10:06:13"));
        Seguro mayor2 = new Seguro(778, "mayorNo", "oscar", "gonzalez", "Strozzi",
                12, Seguro.Sexos.HOMBRE, "N", 0, Timestamp.valueOf("2021-05-02 04:04:05"), Seguro.Seguros.COCHE,  Date.valueOf("2000-02-03"), Time.valueOf("10:06:13"));
...
//        seguroPersistent.insertarSeguro(mayor1);
    ...
    public void testHoraContacto() {
        Seguro hora = new Seguro(889, "hora", "de ", "contacto", "Strozzi",
                20, Seguro.Sexos.HOMBRE, "N", 0, Timestamp.valueOf("2021-05-02 04:04:05"), Seguro.Seguros.COCHE,  Date.valueOf("2001-12-03"), Time.valueOf("11:06:13"));
